...
//   curl -fsSL https://raw.githubusercontent.com/jqbit/TLDR/main/src/tools/tldr-init.js | node - [args]
//
...
function processOpenclaw(opts) {
  ...
  if (!helper) {
    return {
      ...
      label: 'x',
      detail: '~/.openclaw/workspace (helper unavailable in standalone curl|node mode — use `npx -y github:jqbit/TLDR -- --only openclaw`)',
    };
  }
