...
//   curl -fsSL https://raw.githubusercontent.com/ZeroPointNineBar/TLDR/main/src/tools/tldr-init.js | node - [args]
//
...
function processOpenclaw(opts) {
  ...
  if (!helper) {
    return {
      ...
      label: 'x',
      detail: '~/.openclaw/workspace (helper unavailable in standalone curl|node mode — use `npx -y github:ZeroPointNineBar/TLDR -- --only openclaw`)',
    };
  }
