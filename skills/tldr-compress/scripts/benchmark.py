...
def main():
    ...
    # Glob mode: repo_root/tests/tldr-compress/
    # __file__ lives at <repo_root>/skills/tldr-compress/scripts/benchmark.py
    # Walk up four dirs: scripts → tldr-compress → skills → repo_root.
    tests_dir = Path(__file__).resolve().parents[3] / "tests" / "tldr-compress"
