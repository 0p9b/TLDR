#!/usr/bin/env python3
"""Benchmark TLDR vs normal Claude output token counts."""
...
def format_table(rows, summary):
    lines = [
        "| Task | Normal (tokens) | TLDR (tokens) | Saved |",
        "|------|---------------:|----------------:|------:|",
    ]
    for r in rows:
...
def main():
    parser = argparse.ArgumentParser(description="Benchmark TLDR vs normal Claude")
