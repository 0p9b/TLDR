...
2. Otherwise download and run the standalone script (it is self-contained and supports stdin execution): `curl -fsSL https://raw.githubusercontent.com/ZeroPointNineBar/TLDR/main/src/tools/tldr-init.js | node - $ARGUMENTS`
